...
public class NamedQueryRepository {
    ...
    public List<Menu> selectByNamedQuery() {
        List<Menu> menuList = entityManager
                .createNamedQuery("Section08Menu.selectMenuList", Menu.class).getResultList();
        return menuList;
    }

    public List<Menu> selectByNamedQueryWitnXml(int menuCode) {
        List<Menu> menuList = entityManager
                .createNamedQuery("Section08Menu.selectMenuByCode", Menu.class)
